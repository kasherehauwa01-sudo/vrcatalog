...
def upgrade():
    ...
    if "xml_server_settings" not in tables:
        op.create_table(
            ...
            sa.Column("host", sa.String(length=255), nullable=False, server_default="176.53.160.144"),
            sa.Column("port", sa.Integer(), nullable=False, server_default="21"),
            sa.Column("username", sa.String(length=255), nullable=False, server_default="uploader"),
            sa.Column("password", sa.String(length=255), nullable=False, server_default="9963396"),
