...
import { alpha, AppBar, Avatar, Box, Button, Card, CardActionArea, CardContent, CardMedia, Chip, Container, CssBaseline, Divider, Drawer, Grid, IconButton, InputAdornment, LinearProgress, List, ListItemButton, Paper, Stack, Tab, Tabs, TextField, ThemeProvider, Toolbar, Typography, createTheme } from '@mui/material';
  ...
  return <ThemeProvider theme={theme}><CssBaseline />
    <Box sx={{ minHeight: '100vh', background: 'radial-gradient(circle at top left, #f4efff 0, #fffbfe 38%, #fef7ff 100%)' }}>
      ...
      <Container maxWidth="xl" sx={{ py: { xs: 2, md: 4 } }}>
        ...
        <Paper sx={{ mb: 3, px: 1, bgcolor: alpha('#ffffff', .72), border: '1px solid rgba(103,80,164,.12)' }} elevation={0}>
