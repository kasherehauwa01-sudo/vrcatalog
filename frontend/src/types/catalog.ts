export type Product = { id:number; code:string; name:string; article?:string; section?:string; quantity:number; retail_price?:number; prices:{price_type:string; value:number}[] };
